...
api_dir = 'src/api'
remaining_files = [
    'analyzeATS.ts', 'deleteCoverLetter.ts', 'deleteJobApplication.ts',
    'deleteResume.ts', 'exportResumePdf.ts', 'generateCoverLetter.ts',
    'generateInterviewQuestions.ts', 'generateRoadmap.ts', 'generateRoleSOP.ts',
    'getCoverLetters.ts', 'getDashboardStats.ts', 'checkFeatureAccess.ts',
